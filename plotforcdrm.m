...
xlabel('Frequency (Hz)');
ylabel('Magnitude (dB)');
xline(peak_f_ansys, "o--")
%xline(f1, "b--")
%xline(f2, "b--")
title('FRF Undamped Comparison');
xlim([0 500])
legend("Real World Obsert","Peak Frequency Real: " + peak_f + "Hz", "Ansys FEA", "Peak Frequency Ansys: " + peak_f_ansys + " Hz");
